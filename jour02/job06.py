class Commande:
    ...
    def afficher_commande(self):
        ...
        tva = self.__calculer_TVA(10)
        print(f"TVA : {tva}€")
    

commande1 = Commande(1)
commande1.ajouter_plat("Pizza Armenienne", 2)
commande1.ajouter_plat("Coca-Cola", 3)
commande1.ajouter_plat("Spaghetti Bolognaise", 1)
commande1.ajouter_plat("Salade César", 1)
commande1.afficher_commande()
commande1.payer()
commande1.afficher_commande()
commande2 = Commande(2)
commande2.ajouter_plat("Pizza Armenienne", 2)
commande2.ajouter_plat("Coca-Cola", 3)
